...
Page({
  ...
  {
    // 标题设置
    my.setNavigationBar({title: '我的订水订单 My water-order'});
  },
  ...
  get_data_list(is_mandatory)
  {
    ...
    // 获取数据
    my.httpRequest({
      url: app.get_request_url('Index', 'Waterorder'),
      method: 'POST',
    ...
    my.confirm({
      ...
      success: (result) => {
        if(result.confirm)
        {
          ...
          my.showLoading({content: '处理中 processing...'});
          my.httpRequest({
            url: app.get_request_url('Cancel', 'Waterorder'),
            method: 'POST',
            data: {order_id: value},
            dataType: 'json',
            success: (res) => {
    ...
    my.confirm({
      ...
      success: (result) => {
        if(result.confirm)
        {
          ...
          my.showLoading({content: '处理中 processing...'});
          my.httpRequest({
            url: app.get_request_url('Success', 'Waterorder'),
            method: 'POST',
            data: {order_id: value},
            dataType: 'json',
            success: (res) => {
